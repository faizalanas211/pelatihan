...
<div class="row g-4">
    ...
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            ...
            <a href="{{ route('rekap-pelatihan.create') }}" class="btn rounded-4 px-4 py-2 shadow-sm d-inline-flex align-items-center fw-semibold" style="background: linear-gradient(135deg, #f97316, #f59e0b); color: white; border: none; font-size: 0.9rem;">
            ...
            <div class="card border-0 shadow-sm rounded-4" style="background: #fffcf8;">
                <div class="card-body p-3">
                    <div class="row g-3 align-items-end">
                        <div class="col-md-3">
                            <label class="form-label fw-bold mb-1" style="color: #b87a4a; font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.5px;">Tahun</label>
                            <select class="form-select rounded-3 shadow-sm border-0" name="tahun" id="filterTahun" style="background: #ffffff; color: #5c4a3a; font-size: 0.9rem;">
                        ...
                        <div class="col-md-7">
                            <label class="form-label fw-bold mb-1" style="color: #b87a4a; font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.5px;">Cari Pelatihan</label>
                            <div class="input-group rounded-3 overflow-hidden shadow-sm border-0">
                                <span class="input-group-text bg-white border-0">
                                    <i class="bi bi-search" style="color: #f97316;"></i>
                                </span>
                                <input type="text" name="search" class="form-control border-0" id="searchInput" placeholder="Nama pelatihan atau instansi..." value="{{ request('search') }}" style="background: #ffffff; font-size: 0.9rem;">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="d-flex gap-2">
                                ...
                                <a href="{{ route('rekap-pelatihan.index') }}" class="btn rounded-3 shadow-sm" style="background: #ffffff; color: #f97316; border: 1px solid #fed7aa; padding: 0.6rem;">
            ...
            <div class="row g-4">
                    ...
                    <div class="col-md-4">
                        <div class="card rounded-4 border-0 shadow-sm pelatihan-card-grid h-100">
                            <div class="card-body p-4 d-flex flex-column">
                                ...
                                <h5 class="fw-bold mb-2" style="color: #4a3728; font-size: 1.1rem;">{{ $item->jenis_pelatihan }}</h5>
                                ...
                                <div class="mt-auto pt-3 border-top d-flex justify-content-between align-items-center">
                                    <div class="text-muted small">
                                        @php
                                            $jumlahPeserta = DB::table('pelatihan_peserta')->where('pelatihan_id', $item->id)->count();
                                        @endphp
                                        <i class="bi bi-people-fill text-orange me-1"></i> {{ $jumlahPeserta }} Peserta
                                    </div>
                                    <a href="{{ route('rekap-pelatihan.show', $item->id) }}" class="text-orange fw-bold small text-decoration-none btn-hover-link">
                ...
                @empty
                    <div class="col-12 text-center py-5">
                        ...
                        <p class="small text-muted">Belum ada event pelatihan yang diinputkan.</p>
                    </div>
                @endforelse
            </div> 
